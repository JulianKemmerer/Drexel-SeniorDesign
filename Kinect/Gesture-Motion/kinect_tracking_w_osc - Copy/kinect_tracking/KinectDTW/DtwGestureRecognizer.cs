...
namespace kinect_tracking
{
    ...
    internal class DtwGestureRecognizer
    {
        ...
        public string Recognize(ArrayList seq)
        {
            ...
            string classification = MainWindow.UNKNOWN_GESTURE_NAME;
            for (int i = 0; i < _sequences.Count; i++)
            {
                var example = (ArrayList) _sequences[i];

                //Check the last frame as initial measure of gesture likeness
            ...
            return (minDist < _globalThreshold ? classification : MainWindow.UNKNOWN_GESTURE_NAME) + " " /*+minDist.ToString()*/;
        }
