...
namespace kinect_tracking
{
    ...
    public class Skeleton2DdataCoordEventArgs
    {
        ...
        /// 0-HandLeft, 1-WristLeft, 2-ElbowLeft, 3-ElbowRight, 4-WristRight, 5-HandRight, 6-ShoulderLeft, 7-ShoulderRight
        /// </summary>
        public Point[] _points;
        //Index of skeleton (identify which of the two tracked skeletons this is)
        public int index;

        public Point center_point = new Point();
        public float distance_normalizer = 0;
